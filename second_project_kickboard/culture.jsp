								...
								<div "id="content" class="col-8 col-12-medium imp-medium">
									...
									<!-- Post -->
										<article class="box post">
											...
											<a onclick="location.href='course_3.jsp'" href="#" class="num" style="display:inline-block; margin-top:125px; margin-bottom:125px;font-size: 17px;">우리나라 최대 규모의 산성을 걸어보자<br>#계곡#공원#휴양림#산성#유적#사찰<br>#풍경감상#역사문화탐방#힐링</a></span>
