								...
								<div "id="content" class="col-8 col-12-medium imp-medium">
									...
									<!-- Post -->
										<article class="box post">
											...
											<span class="image featured"><img src="images/pic22-1.png" alt="" /></span>
											...
											<a onclick="location.href='course_4.jsp'" href="#" class="num" style="display:inline-block; margin-top:125px; margin-bottom:125px;font-size: 17px;">영화 마니아를 위한 로맨팅 여행<br>#체험#문화마을#레포츠#탐방로#촬영지#테마공간<br>#트레킹#맛집탐방#풍경감상#전시관람#힐링</a></span>
											<span class="image featured"><img src="images/romantic.png" alt="" /></span>
											
											<span class="image featured"><img src="images/pic6.png" style="height:300px; width:300px; margin:10px 40px; display:inline-block; float:left">
											<a onclick="location.href='course_22.jsp'" href="#" class="num" style="display:inline-block; margin-top:125px; margin-bottom:125px;font-size: 17px;">우리나라 최대 규모의 산성을 걸어보자<br>#계곡#공원#휴양림#산성#유적#사찰<br>#풍경감상#역사문화탐방#힐링</a></span>
											<span class="image featured"><img src="images/pic123.png" alt="" /></span>
										</article>
