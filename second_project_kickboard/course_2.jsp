			...
			<!-- Header -->
				<section id="header">
					<div class="container" style="padding-top: 80px;">
						...
						<!-- Logo -->
							<h1 id="logo"><a href="A_E_map_bambada_info.jsp">활동성코스(1-2)</a></h1>
...
<!-- 수정시작 -->
			...
			var mapContainer = document.getElementById('map'), // 지도를 표시할 div  
    			mapOption = { 
        			center: new kakao.maps.LatLng(35.1387032, 129.1271956), // 지도의 중심좌표
        			level: 8 // 지도의 확대 레벨
    			};
			...
			<p></p>
					...
					<h3>추천코스</h3>
					<p> </p>
					<p>#9월#레포츠#쇼핑#공원#랜드마크#풍경감상#휴양#힐링</p>
					<p>7.9km 36분 코스</p>
					<h3 style = "text-align: left;">1.오륙도 스카이워크</h3>
					<h3 style = "text-align: left;">2.이기대 도시자연공원</h3>
					<h3 style = "text-align: left;">3.신세계 센텀시티</h3>
					<h3 style = "text-align: left;">4.부산 영화의전당</h3>
					<p>A_E_map_bambada</p>
					</article>
